...
2.4 Si no se resuelve:
- Si tras 2 intentos razonables no se resuelve o el usuario no brinda el modelo/tipo de sensor, derivar a WhatsApp (ver links en “Rutas TPMS” abajo).
