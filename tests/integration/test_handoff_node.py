"""
Integration tests for the handoff node.

Wraps tests/test__node_handoff.scenarios.json.
All scenarios are tagged no_llm — fully offline.

Run:
    pytest tests/integration/test_handoff_node.py -v
"""
...
_BUNDLE = Path(__file__).parent.parent / "test__node_handoff.scenarios.json"
